class SendgridMailer
  ...
  def send_notification_to_admin
    ...
    subsitutions = {
      ...
      shipping_address_line_1: shipping_address.get_street1,
      shipping_address_city: shipping_address.get_city,
      shipping_address_state_province_region:  CANADA_PROVINCES.key(shipping_address.get_state_or_province),
      shipping_address_postal_code: shipping_address.get_postal_code,
      country: shipping_address.country,
      billing_address_line_1: billing_address.get_street1,
      billing_address_city: billing_address.get_city,
      billing_address_state_province_region:  CANADA_PROVINCES.key(billing_address.get_state_or_province),
      billing_address_postal_code: billing_address.get_postal_code,
